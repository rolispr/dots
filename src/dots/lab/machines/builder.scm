...
;;;   git clone <dots> ~/dots
;;;   guix build claude-code -L ~/dots/src     # build whatever you need
...
;;;       > ~/dots/keys/builder.pub
;;;   git -C ~/dots add keys/builder.pub && git commit ...
;;;   guix deploy -L ~/dots/src ~/dots/fleet.scm   # other VMs now trust builder

(define-module (dots lab machines builder)
  #:use-module (gnu)
  #:use-module (gnu services)
  #:use-module (gnu services guix)
  #:use-module (dots lab prelude)
  #:export (builder-os))
