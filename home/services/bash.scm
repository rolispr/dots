...
(define* (home-bash-service #:key (config-dir "~/dots/home/config"))
  ...
  (service home-bash-service-type
           (home-bash-configuration
            (aliases '(("ll" . "ls -l")
                       ("la" . "ls -la")
		       ("update-system" . "sudo -E guix system -L ~/dots -L ~/dots/per-host/$(hostname) reconfigure ~/dots/etc/systems/config.scm")
		       ("update-home" . "guix home -L ~/dots -L ~/dots/per-host/$(hostname) reconfigure ~/dots/home/config.scm")))
