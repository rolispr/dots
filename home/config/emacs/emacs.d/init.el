...
;; Customize/ maybe use setopt instead?
...
;; (setq directory-abbrev-alist '(("\\`/org" . "/home/bret.horne/doc/org")))
...
;; nsm.el
;; (setq nsm-settings-file (user-data "network-security.data"))
;; Initialization
...
;; Bindings
;; (define-key global-map (kbd "your-keybinding") 'your-function) ; Add your keybindings here
...
(setq package-selected-packages
      '(evil
	vertico consult corfu embark embark-consult orderless cape
	undo-fu evil evil-collection vim-tab-bar dashboard
	marginalia kind-icon all-the-icons-completion
	magit tempel ligature ligatures git-gutter-fringe 
	tabspaces wgrep dired-git-info dired-subtree dirvish
	eglot-tempel tempel-collection ;; lsp lsp-ui
	fireplace zone-nyan emms devdocs
	terraform-mode rustic fennel-mode
	cider-mode css-mode web-mode
	markdown-mode nix-mode ansible
	parinfer-rust-mode paredit sly sly-asdf rainbow-delimiters
	vterm shelldon bash-completion))

...
(use-package dashboard
  ...
  (setq dashboard-startup-banner 'logo
        ...
        dashboard-items '((recents . 5)
                         (projects . 3)
                         (registers . 3)))
  ;; Start with dashboard and eshell
...
(use-package corfu
  ...
  :custom
  (corfu-auto t)
  (corfu-quit-at-boundary t)   ;; Automatically quit at word boundaries
  (corfu-quit-no-match t)      ;; Automatically quit if there is no match
  (corfu-preview-current nil)  ;; Disable current candidate preview
  (corfu-auto-prefix 2)        ;; Require more characters for auto-completion
  (corfu-cycle t)
  ;;(corfu-auto-prefix 1)
...
;; - mini-echo-mode
;; - and the following bits of code
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(which-key-posframe dashboard olivetti evil vertico consult corfu embark embark-consult orderless cape undo-fu evil evil-collection vim-tab-bar marginalia kind-icon all-the-icons-completion magit tempel ligature ligatures git-gutter-fringe tabspaces wgrep dired-git-info dired-subtree dirvish eglot-tempel tempel-collection fireplace zone-nyan emms devdocs terraform-mode rustic fennel-mode cider-mode css-mode web-mode markdown-mode nix-mode ansible parinfer-rust-mode paredit sly sly-asdf rainbow-delimiters vterm shelldon bash-completion)))
(custom-set-faces
 ...
 '(internal-border ((t :background "#161a2a")))
 '(mini-echo-minibuffer-window ((t (:inherit tab-bar))))
 '(mode-line ((t :background "#161a2a")))
 '(mode-line-inactive ((t :background "#161a2a")))
 '(vertical-border ((t :background "#212337" :foreground "#212337")))
 '(window-divider ((t :background "#212337" :foreground "#212337")))
 '(window-divider-first-pixel ((t :background "#212337" :foreground "#212337")))
 '(window-divider-last-pixel ((t :background "#212337" :foreground "#212337"))))
